...
public class ServiceATMImplementation implements ServiceATM {
    ...
    public void changePin(Card card) {
        ...
        if (card.getPin().equals(password)) {
            ...
            System.out.println("");
            System.out.println("");
            System.out.println("Succesfully completed. Your password has been changed.");
        } else {
    ...
    public void getBalance(Card card) {
        System.out.println("In your card account there is : " + card.getBalance());
    }
        ...
        switch (scanner.nextInt()) {
            case 1: {
                ...
                if (card.getBalance() >= money) {
                    ...
                    System.out.println("In your account there is: " + (card.getBalance() - money) + " sums left.");
                    System.out.println("Service fee is: " + (50000 * 0.01));
                } else {
                    System.out.println("There is not enough money in you account!");
                }
                break;
            }
            ...
            case 2: {
                ...
                if (card.getBalance() >= money) {
                    ...
                    System.out.println("In your account  there is: " + (card.getBalance() - money) + " soums left.");
                    System.out.println("Service fee is: " + (100000 * 0.01));
                } else {
            ...
            case 3: {
                ...
                if (card.getBalance() >= money) {
                    ...
                    System.out.println("In your account there is :" + (card.getBalance() - money) + " soums left.");
                    System.out.println("Service fee is : " + (150000 * 0.01));
                } else {
                    System.out.println("There is not enough money in your account!");
                }
                break;
            ...
            case 4: {
                ...
                if (card.getBalance() >= money) {
                    ...
                    System.out.println("In your account there is : " + (card.getBalance() - money) + " soums left.");
                    System.out.println("Service fee is : " + (20000 * 0.01));
                } else {
                    System.out.println("There is not enough money in your account!");
                }
                break;
...
//                        sum4 = (money - count100 * 100000 - count50 * 50000 - count20 * 20000) / 1;
                            ...
                            System.out.println("In your account there is: " + (card.getBalance() - moneySum) + " soums left.");
                            System.out.println("Service fee is: " + (money * 0.01));
                        } else {
                            System.out.println("There is not enough money in your account.!");
                        }
                        System.out.println("================================");
    ...
    public boolean replenishAccount(Card card) {
        ...
        boolean shart = true;
        while (shart) {
            System.out.println("Enter your amount of cash.");
